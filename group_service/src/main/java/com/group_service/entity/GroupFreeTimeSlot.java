...
@Entity
@Table(name = "group_free_time_slots", uniqueConstraints = @UniqueConstraint(name = "uk_group_term_day_slot", columnNames = {"group_id", "term_id", "day_of_week", "slot_code"}))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class GroupFreeTimeSlot {
    @Id
